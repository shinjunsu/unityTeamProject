...
namespace KWNET
{
        ...
        where TMessage : IMessage, new()
	{
         ...
         */
		public bool ExportFunctionFromEnum()
		{
            string functionName = "onRecv";
			try
			{
				...
				DispatchInfo dispatchInfo = TryGetMessageDispatch(0);
				if (dispatchInfo == null)
					dispatchList.Add(0, new DispatchInfo(loadedFunction));
				else
     ...
     */
	public abstract class DefaultDispatchHelper<TSession> : DispatchHelper<TSession, DefaultMessage<TSession>, onDispatch<TSession>>
		where TSession : new()
	{
		/**
		...
		protected override bool OnInit()
		{
			...
			if (ExportFunctionFromEnum() == false)
				return false;
